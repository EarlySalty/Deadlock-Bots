...
- **Support-Tickets:** Über den Button im Channel <#1459628609705738539> öffnest du einen privaten Ticket-Kanal fürs Team. Die erste Nachricht wird nur intern im Shadow geprüft: Stufe 1 bewertet `yes`, `no` oder `uncertain`, Stufe 2 erzeugt unabhängig vom Urteil immer einen kurzen deutschen Antwortkandidaten. Urteil und Kandidat erscheinen ausschließlich im internen Shadow-Kanal; der Bot schreibt niemals automatisch ins Ticket. Technische Generatorfehler bleiben dort knapp sichtbar.
