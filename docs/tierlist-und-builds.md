...
Zum gleichen oeffentlichen Bereich gehoert die Turnier-Seite. Dort siehst du aktuelle Anmeldephasen, Solo-Anmeldungen, Teams und einen automatisch erzeugten Bracket-Stand. Wenn eine Turnier-Phase offen ist, kannst du dich nach Discord-Login direkt ueber die Website anmelden oder wieder austragen. Fuer Team-Anmeldungen lassen sich Team-Namen anlegen, umbenennen und Mitglieder verwalten.
...
- Turnier-Anmeldungen funktionieren nur waehrend eines aktiven Anmeldezeitraums.
- Fuer Turnier-Signups brauchst du einen verifizierten Steam-Account und die passende Turnier-Rolle.
...
## Für Devs (knapp)
- Cogs: `cogs/tierlist_public_cog.py`, `cogs/turnier_public_cog.py`, `cogs/build_publisher.py`
- Abhangigkeiten: `service/tierlist_public.py`, `service/turnier_public.py`, Tournament-Store, Deadlock-API, Steam-Bridge-Taskqueue
