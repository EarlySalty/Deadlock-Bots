...
mod tests {
    ...
    fn offener_testmodus_verlangt_semantische_evidence_passung() {
        ...
        assert!(OPEN_TEST_SYSTEM.contains("hero_tempo_profile"));
        assert!(OPEN_TEST_SYSTEM.contains("classification clear oder supported"));
        assert!(OPEN_TEST_SYSTEM.contains("curve_only"));
        assert!(OPEN_TEST_SYSTEM.contains("höchstens fünf"));
