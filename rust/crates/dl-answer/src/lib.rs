...
mod tests {
    ...
    fn offener_testmodus_verlangt_semantische_evidence_passung() {
        assert!(OPEN_TEST_SYSTEM.contains("Ein gemeinsames Teilwort reicht ausdrücklich nicht"));
        assert!(OPEN_TEST_SYSTEM.contains("Healing Tempo"));
        assert!(OPEN_TEST_SYSTEM.contains("Tempo-Charakteren"));
