...
--
-- `dispatch_claimed_at` schuetzt nur die ABSICHT ("ich arbeite dran"), nicht die
-- TAT. Der Beweis fuer den Versand war bisher der Audit-Eintrag — der aber erst
-- NACH dem Versand geschrieben wird und genau dabei fehlschlagen kann. Folge:
-- Zeile bleibt stehen, Claim laeuft nach 120 s ins Stale, der naechste Pass
