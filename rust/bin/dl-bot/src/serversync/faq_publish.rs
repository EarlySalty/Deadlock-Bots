...
pub const FAQ_MAIN_BODY: &str = "Wähl unten deine Frage aus — die Antwort siehst nur du.\nNichts Passendes dabei? Server-, Bot- und Concierge-Fragen stellst du in <#1491953161747955853>. Für Support oder Moderation öffnest du ein Ticket in <#1459628609705738539>.";
...
pub const FAQ_ANSWER_F6: &str = "**🚧 Steam sagt „limited account\" — warum kein Invite?**\nDas ist eine Beschränkung von Valve, kein Fehler bei uns: „Limited\" sind Steam-Accounts, die noch nie mindestens 5 $ im Steam-Store ausgegeben haben — solche Accounts können über unseren Weg keine Playtest-Einladung erhalten. Sobald du einmalig für 5 $ irgendwas auf Steam gekauft hast, fällt die Sperre weg. Wenn du unsicher bist, mach ein Ticket in <#1459628609705738539> auf — das Team geht die Optionen mit dir durch.";
...
pub const FAQ_ANSWER_F15: &str = "**🧭 Wo fange ich an — und wo kann ich fragen?**\nFolg einfach der Server-Guide-Checkliste oben im Kanalbaum: Sag Hallo in <#1426220702054355077>, verknüpf deinen Steam-Account, such dir Mitspieler — in der Reihenfolge, ohne Zeitdruck. Server-, Bot- und Concierge-Fragen stellst du in <#1491953161747955853>. Für offene Community-Fragen oder einen Deadlock-Invite passt <#1426220702054355077>.";
