...
| 1 | Korpus-Regeneration internal/ + FAQ-Entwurf | Union Alpha (frei) | in Arbeit: 2 Docs auf main (Deadlock-Docs 18abfcd) |
...
Phase 1 weiter: internal-Docs fuer deadlock-brain (Spielwissen-Retrieval), tb-llm/dl-ai (zentraler Provider), und die uebrigen Kern-Crates, je chunked. Danach FAQ-Entwurf (nur Entwurf, nie public/ automatisch). Dann Phase 2 als normaler Rust-Build mit Review und Gate.
