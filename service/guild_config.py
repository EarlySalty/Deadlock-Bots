...
class GuildIDs:
    ...
    TEMPVOICE_PERMANENT_CASUAL_CHANNEL: int = 1493690350580138114
    ...
    # TempVoice Router
    TEMPVOICE_ROUTER_VC: int = 1513468587195633674
    TEMPVOICE_ROUTER_TEXT: int = 1513468476365209670
    TEMPVOICE_ROUTER_CATEGORY: int = 1513468298728308757
    TEMPVOICE_RANKED_INFO_CHANNEL: int = 1474827277610254570
